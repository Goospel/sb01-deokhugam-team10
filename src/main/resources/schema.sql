...
ALTER TABLE review
    ADD CONSTRAINT pk_review_id PRIMARY KEY (review_id, book_id, user_id);
ALTER TABLE comment
    ADD CONSTRAINT pk_comment_id PRIMARY KEY (comment_id, review_id, book_id, user_id);
ALTER TABLE notification
    ADD CONSTRAINT pk_notification_id PRIMARY KEY (notification_id, review_id, book_id, user_id);
